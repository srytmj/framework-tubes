                    ...
                    <form action="{{ route('pegawai.store') }}" method="post">
                        ...
                        <fieldset disabled>
                            <div class="mb-3"><label for="pegawaiidlabel">Id Pegawai</label>
                                <input class="form-control form-control-solid" id="id_pegawai_tampil"
                                    name="id_pegawai_tampil" type="text" placeholder="Contoh: PGW-001"
                                    value="{{ $pegawai_id }}" readonly>
                            </div>
                        </fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-solid" id="pegawai_nama"
                                name="pegawai_nama" placeholder="Contoh: John Doe" value="{{ old('pegawai_nama') }}">
                        </div>

                        <!-- Nomor Telepon Pegawai -->
                        <div class="mb-3">
                            <label for="pegawai_no_telepon" class="form-label">Nomor Telepon</label>
                            <input type="text" class="form-control form-control-solid" id="pegawai_no_telepon"
                                name="pegawai_no_telepon" placeholder="Contoh: 081234567890"
                                value="{{ old('pegawai_no_telepon') }}">
                        </div>

                        <!-- Alamat Pegawai -->
                        <div class="mb-3">
                            <label for="pegawai_alamat" class="form-label">Alamat Pegawai</label>
                            <textarea class="form-control form-control-solid" id="pegawai_alamat" name="pegawai_alamat" rows="3"
                                placeholder="Contoh: Jl. Bunga Matahari No. 16">{{ old('pegawai_alamat') }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pegawai_jenis_kelamin"
                                    id="jenis_kelamin_l" value="L"
                                    {{ old('pegawai_jenis_kelamin') == 'L' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="pegawai_jenis_kelamin"
                                    ...
                                    {{ old('pegawai_jenis_kelamin') == 'P' ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-solid" id="pegawai_jabatan" name="pegawai_jabatan">
                                ...
                                @foreach ($jabatans as $jabatan)
                                    <option value="{{ $jabatan->jabatan_nama }}"
                                        {{ old('pegawai_jabatan') == $jabatan->jabatan_nama ? 'selected' : '' }}>
