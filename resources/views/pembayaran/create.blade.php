          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Konfirmasi Pembayaran</h5>
                ...
                <form action="{{ route('pembayaran.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" id="transaksi_no" name="transaksi_no" value="{{$transaksi_no}}">
                        ...
                        <fieldset disabled>
                            ...
                            <input class="form-control form-control-solid" id="kode" name="kode" type="text" value="{{$transaksi_no}}" readonly></div>
                        </fieldset>
                                        ...
                                        <div class="col-sm-10" align="left">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>=</td>
                                                    <td style="text-align:right">{{rupiah($k->produk_harga)}}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    Jumlah Barang
