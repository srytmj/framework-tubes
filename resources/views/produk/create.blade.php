                ...
                <form action="{{ route('produk.store') }}" method="post">
                    ...
                    <fieldset disabled>
                      <div class="mb-3">
                          ...
                          <input class="form-control form-control-solid" id="kode_produk_tampil" name="kode_produk_tampil" type="text" placeholder="Contoh: PD-001" value="{{$kode_produk}}" readonly>
                      </div>
                    </fieldset>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid" id="nama_produk" name="nama_produk" type="text" placeholder="Contoh: Es Teh" value="{{old('nama_produk')}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid" id="harga_produk" name="harga_produk" type="text" placeholder="Contoh: 15000" value="{{old('harga_produk')}}">
                    </div>
