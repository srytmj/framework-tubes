                                    ...
                                    <form action="{{ url('midtrans/proses_bayar') }}" id="x-submit-form" method="post">
                                        ...
                                        <fieldset disabled>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control form-control-solid" id="kode" name="kode"
                                                    type="text" value="{{ $transaksi_no }}" readonly>
                                            </div>
                                        </fieldset>
                                        <div class="container my-3">
                                            <label for="namaperusahaanlabel" class="form-label">
                                                Isi Keranjang <b>({{ rupiah($totaltagihan) }})</b>
                                            </label>
                                            <ul class="list-group">
                                                @foreach ($keranjang as $k)
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-2">
                                                                <img width="100%" height="auto"
                                                                    src="{{ url('fotoproduk') }}/{{ $k->produk_foto }}"
                                                                    zn_id="79" alt="{{ $k->produk_nama }}"
                                                                    class="img-thumbnail">
                                                            </div>
                                                            <div class="col-sm-10">
                                                                <b>{{ $k->produk_nama }}</b>
                                                                <table class="table table-borderless mt-1 mb-0">
                                                                    <tr>
                                                                        ...
                                                                        <td>=</td>
                                                                        <td class="text-end">{{ rupiah($k->produk_harga) }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Jumlah Barang</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>Total Harga</td>
                                                                        <td>=</td>
                                                                        <td class="text-end">{{ rupiah($k->total) }}</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </div>
                                        ...
                                        <a class="col-sm-1 btn btn-dark  btn-sm" href="{{ url('midtrans/bayar') }}"
                                            role="button">Batal</a>
