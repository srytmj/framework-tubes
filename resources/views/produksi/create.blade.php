                ...
                <form action="{{ route('produksi.store') }}" method="post">
                  ...
                  <fieldset>
                      ...
                      <div class="mb-3">
                        ...
                        <input class="form-control form-control-solid" id="tanggal_produksi" name="tanggal_produksi" type="date"">
                    </div>

                  </fieldset>
                  <input type="hidden" id="produksi_kode" name="produksi_kode" value="{{$produksi_kode}}">
                  <br>
                  <!-- untuk tombol simpan -->
