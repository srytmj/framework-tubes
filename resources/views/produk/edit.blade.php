                    ...
                    <form action="{{ route('produk.update', $produk->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset disabled>
                            <div class="mb-3">
                                ...
                                <input class="form-control form-control-solid" id="produk_kode_tampil"
                                    name="produk_kode_tampil" type="text" placeholder="Contoh: PD-001"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="produk_nama" name="produk_nama"
                                type="text" placeholder="Contoh: Es Teh" value="{{ $produk->produk_nama }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control form-control-solid" id="produk_jenis" name="produk_jenis">
                                ...
                                <option value="Paket" {{ old('produk_jenis') == 'Paket' ? 'selected' : '' }}>Paket
                                </option>
                                <option value="Tambahan" {{ old('produk_jenis') == 'Tambahan' ? 'selected' : '' }}>Tambahan
                                </option>
                                <option value="Minuman" {{ old('produk_jenis') == 'Minuman' ? 'selected' : '' }}>Minuman
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="produk_harga" name="produk_harga"
                                type="text" placeholder="Contoh: 15000" value="{{ $produk->produk_harga }}">
                        </div>

                        <div class="mb-3">
                            <label for="produk_foto_label">Foto Produk</label>
                            <input class="form-control form-control-solid" id="produk_foto" name="produk_foto"
