            ...
            <h5 class="card-title fw-semibold mb-4">Data Distributor</h5>
                ...
                <form action="{{ route('distributor.update', $distributor->id) }}" method="post">
                    ...
                    <fieldset disabled>
                        ...
                        <input class="form-control form-control-solid" id="distributor_kode_tampil" name="distributor_kode_tampil" type="text" placeholder="Contoh: DR-001" value="{{$distributor->distributor_kode}}" readonly></div>
                    </fieldset>
