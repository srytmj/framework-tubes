                        ...
                        <div class="card-body">
                                ...
                                <?php
                                    foreach($grafik as $dt){
                                        $waktu[] = $dt->waktu;
                                        $jml_lays[] = (int)$dt->jml_lays;
                                        $jml_biskuit[] = (int)$dt->jml_biskuit;
                                        $jml_ice_cream[] = (int)$dt->jml_ice_cream;
                                        $jml_pensil[] = (int)$dt->jml_pensil;
                                    }
                                ?>
                            <div id="grafik">
...
<script>
        ...
        var options = {
                series: [
                    {
                        name: 'Lays',
                        data: <?php echo json_encode($jml_lays);?>
                    },
                    {
                        name: 'Biskuit',
                        data: <?php echo json_encode($jml_biskuit);?>
                    },
                    {
                        name: 'Ice Cream',
                        data: <?php echo json_encode($jml_ice_cream);?>
                    },
                    {
                        name: 'Pensil',
                        data: <?php echo json_encode($jml_pensil);?>
                    }
                ],
                chart: {
                    type: 'bar',
