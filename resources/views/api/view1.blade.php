            ...
            <div class="container-fluid">
                <div class="card-body">
                    <center>
                        ...
                        <p class="card-text">JUMLAH POPULASI TERNAK DI KOTA BANDUNG</p>
                        <hr />
                            ...
                            @foreach ($data as $d)
                                <div class="col">
                                    <div class="card h-100">
                                        <div class="card-body">
                                            <h5 class="card-title">{{ $d['kategori_ternak'] }}</h5>
                                            <p class="card-text">Data Pada Provinsi {{ $d['nama_provinsi'] }}</p>
                                            <p class="card-text">Data Pada Kota {{ $d['bps_nama_kabupaten_kota'] }} Tahun
                                                {{ $d['tahun'] }}</p>
                                            <p class="card-text">Data Pada Kecamatan {{ $d['bps_nama_kecamatan'] }}</p>
                                            <p class="card-text">Jumlah Populasi
                                                {{ number_format($d['jumlah'], 2) }} {{ $d['satuan'] }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
