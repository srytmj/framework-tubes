...
@section('konten')
    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Data Penggajian Pegawai</h5>
                    ...
                    <form action="{{ route('pegawaipenggajian.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-solid" id="pegawai_ids" name="pegawai_ids"
                                onchange="updateJabatan()">
                                <!-- Placeholder -->
                                <option value="" selected disabled>Select Pegawai</option>
                                @foreach ($pegawai as $p)
                                    <option value="{{ $p->pegawai_id }}|{{ $p->pegawai_jabatan }}">{{ $p->pegawai_nama }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-solid" id="pegawai_jabatan"
                                name="pegawai_jabatan" readonly>
                        </div>
                        
                        <!-- pegawai_id -->
                        <div class="mb-3">
                            <label for="pegawai_id" class="form-label">pegawai_id</label>
                            <input type="text" class="form-control form-control-solid" id="pegawai_id"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control form-control-solid" id="jam_kerja" name="jam_kerja"
                                value="{{ old('jam_kerja') }}" onchange="calculateGaji()">
                        </div>
