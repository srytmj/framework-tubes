                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-8">
                                ...
                                <a href="#collapseCardExample{{$p->id}}" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">{{ $p->produk_nama }}</h6>
                                </a>
                                ...
                                <div class="collapse show" id="collapseCardExample{{$p->id}}">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-4" align="justify">
                                                <i class="ti ti-package"></i>&nbsp;&nbsp;produk_stok <b id="xstok-{{$p->id}}">{{ $p->produk_stok }}</b><br><br>
                                                <i class="ti ti-credit-card"></i>&nbsp;&nbsp;Rp {{ number_format($p->produk_harga) }} <br><br>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <input type="hidden" id="tipeproses" name="tipeproses" value="">
                ...
                <div class="mb-3 row">
                    <label for="nomerlabel" class="col-sm-4 col-form-label">Nama Produk</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="produk_nama" name="produk_nama" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="lantailabel" class="col-sm-4 col-form-label">Harga Produk</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="produk_harga" name="produk_harga" readonly>
                    </div>
                </div>
                <div class="mb-3 row">
              ...
              $.ajax(
                {
                    ...
                    success: function (response) {
                        ...
                        $('#produk_nama').val(response.produk[0].produk_nama);
                        $('#produk_harga').val(number_format(response.produk[0].produk_harga));
                        $('#jumlah').attr(
                            {
                                'min':1,
                                'max':response.produk[0].produk_stok
                            }
                        );
                        $('#idprodukhidden').val(response.produk[0].id);
                    }
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (response){
                                        ...
                                        if (response.status == 400) {
                                            ...
                                            // ubah tampilan produk_stok
                                            // get htmlnya
                                            // dapatkan idnya dari
                                            var id = $('#idprodukhidden').val();
                                            refreshstok();
...
<!-- Proses merefresh isian produk_stok dan list -->
<script>
        function refreshstok(){
            $.ajax(
                {
                    type: "GET",
                    url: "{{url('penjualan/produk')}}",
                    dataType: "json",
                    success: function (response) {
                        $.each(response.produk, function (key, item) {
                            // update elemen produk_stok html
                            var idelemenstok = "#xstok-"+item.id;
                            $(idelemenstok).html(item.produk_stok);
                        });
                    }
                }
            )
